...
/**
 * Support for user self unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'ibobenrol'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/ibobenrol/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_ibobenrol', format_string($course->fullname));
