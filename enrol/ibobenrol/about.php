...
$pageparams = array();
admin_externalpage_setup('enrol_ibobenrol_about', '', $pageparams);
$siteurl = new moodle_url('/enrol/ibobenrol/about.php', $pageparams);
...
$params = array('ibobenrol' => html_writer::link('https://moodle.org/plugins/local_bs_badge_ladder', 'Badge Ladder',
    array('target' => '_blank')),
...
$abouttext = html_writer::div(get_string('abouttext', 'enrol_ibobenrol', $params), 'about-text');
$donationtext = html_writer::div(get_string('donationtext', 'enrol_ibobenrol'), 'donation-text');

$params = array('aboutlink' => html_writer::link('https://moodle.org/plugins/enrol_ibobenrol',
    get_string('plugindirectory', 'enrol_ibobenrol'), array('target' => '_blank')),
    'aboutmail' => html_writer::link('mailto:moodle@matthiasschwa.be', 'moodle@matthiasschwa.be'));

$aboutfeedback = html_writer::div(get_string('aboutfeedbacktext', 'enrol_ibobenrol', $params), 'aboutfeedback-text');
