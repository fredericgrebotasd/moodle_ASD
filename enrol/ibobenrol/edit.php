...
$PAGE->set_url('/enrol/ibobenrol/edit.php', array('courseid' => $course->id, 'id' => $instanceid));
...
if ($instanceid) {
    $instance = $DB->get_record('enrol',
        array('courseid' => $course->id, 'enrol' => 'ibobenrol', 'id' => $instanceid), '*', MUST_EXIST);
} else {
...
$mform = new enrol_ibobenrol_edit_form(null, array($instance, $plugin, $context));
