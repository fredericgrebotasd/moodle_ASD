...
class ibob_client {
    ...
    public static function get_client_id() {
        return get_config('local_ibob', 'obfclientid');
    }
    ...
    public static function get_api_url() {
        $url = get_config('local_ibob', 'apiurl');
    ...
    {
        $siteurl = get_config('local_ibob', 'obf_site_url');
    ...
    public function require_client_id() {
        ...
        if (empty($clientid)) {
            throw new Exception(get_string('apierror0', 'local_ibob'), 0);
        }
    }
    ...
    */
    ...
    public function authenticate($signature, $url) {
        ...
        if (!is_writable($pkidir)) {
            throw new Exception(get_string('pkidirnotwritable', 'local_ibob',
                    $pkidir));
        }
