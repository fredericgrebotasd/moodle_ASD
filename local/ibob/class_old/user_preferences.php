...
class ibob_user_preferences {
    ...
    public static function get_user_preference($userid, $preference) {
        global $DB;
        $record = $DB->get_record('local_ibob_user_preferences', array('user_id' => $userid,
                'name' => $preference));
        if ($record) {
            return $record->value;
        }
    ...
    public function get_preferences($force = false) {
        ...
        $records = $DB->get_records('local_ibob_user_preferences', array('user_id' => $this->userid));
        if ($records) {
            $this->indb = true;
    ...
    public function save_preferences($data) {
        ...
        $preftable = 'local_ibob_user_preferences';
